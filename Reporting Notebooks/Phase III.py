...
# MAGIC <br>
# MAGIC
# MAGIC Below is a diagram depicting the logic that was used for joining both the Daily and Hourly datasets to the OTPW dataset.  Due to the estimated nature of our UTC timestamps in the weather dataset, we created a new feature, 'three_hours_prior_to_departure' from which to join the weather observations. This additional hour buffer ensures that we do not violate the requirement of making predictions two hours prior to departure. 
# MAGIC
# MAGIC <br>
# MAGIC
# MAGIC <div style="text-align: center;">
...
# MAGIC <br>
# MAGIC
# MAGIC Below is an example of exploratory analysis we conducted on some of the flight data. While we were not surprised to encounter differences in average delays by airline (carrier), the level of variation across carriers helps to underscore the importance of carrier-based features in our models. We use this information in our modeling, as detailed in sections below.
# MAGIC
# MAGIC <br>
# MAGIC
# MAGIC <div style="text-align: center;">
...
# MAGIC  Random Forest| 95 |numTrees = 50 <br> maxDepth = 30 <br>inInstancesPerNode=1000<br>minInfoGain = 0.0001|Engineered weather (18)<br>Engineered time/airline/airport (8) <br>Raw time/airline/airport (6)|32| 4 Years | |26.5|28 GB Memory<br>8 cores
# MAGIC  Multilayer Perceptron| 125 |20 Numeric features<br>hidden layers = 2 x 28<br>maxIter  = 20<br>tol = E-6<br>step = 0.03|Features selected by engineered LR (37)|37| 4 Years | |25.5|28 GB Memory<br>8 cores
...
# MAGIC
# MAGIC The resulting ensemble model, when ran on the validation set produced precision 0f 27.6% at 79.5% level of recall and demonstrated F1 score of 41 and F2 score of 57.8 . The graph below shows distribution of the delays separately for the subset that was predicted by the model as as "delayed" and "on time". 
# MAGIC
# MAGIC <br>
# MAGIC <div style="text-align: center;">
