...
#### FULL DATASET, CLEANED, NOT SPLIT
data_df = spark.read.parquet(f"{team_blob_url}/BK/clean_5yr").cache()
...
data_df.write.parquet(f"{team_blob_url}/BK/5yr_imputed")

# COMMAND ----------

# MAGIC %md 
# MAGIC ### Check the data size
